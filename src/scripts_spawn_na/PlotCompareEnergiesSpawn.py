...
def read_data(data_o, data_s):
    ...
    timegrido = data_o.load_energy_timegrid()
    timeo = timegrido * parameters_o["dt"]
    energieso = data_o.load_energy(split=True)
...
def plot_energies(parameters_o, parameters_s, data_ref, data):
    ...
    for index, datum in enumerate(data):
        ...
        fig.savefig("energies_compare_components_group"+str(index)+GD.output_format)
        close(fig)
        ...
        fig.savefig("energies_compare_packetsum_group"+str(index)+GD.output_format)
        close(fig)
        ...
        fig.savefig("energies_compare_sumall_group"+str(index)+GD.output_format)
        close(fig)
        ...
        fig.savefig("energies_compare_sumall_drift_group"+str(index)+GD.output_format)
        close(fig)
        ...
        fig.savefig("energies_compare_components_diff_group"+str(index)+GD.output_format)
        close(fig)
        ...
        fig.savefig("energies_compare_sumall_diff_group"+str(index)+GD.output_format)
        close(fig)
