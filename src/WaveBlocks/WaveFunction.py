...
class WaveFunction:
    r"""
    This class represents a vector valued quantum state :math:`|\Psi\rangle` as used in the vector valued
    time-dependent Schroedinger equation. The state :math:`|\Psi\rangle` is composed of :math:`\psi_0, \ldots, \psi_{N-1}`
    where :math:`\psi_i` is a single wavefunction component.
    """

    def __init__(self, parameters):
        r"""
        Initialize the :py:class:`WaveFunction` object that represents the vector of states :math:`|\Psi\rangle`.

        :param parameters: A :py:class:`ParameterProvider` instance with at least the items 'ncomponents', 'f' and 'ngn'.
        """
    ...
    def __str__(self):
        r"""
        :return: A string that describes the wavefunction :math:`|\Psi\rangle`.
        """
    ...
    def get_number_components(self):
        r"""
        :return: The number of components :math:`\psi_i` the vector :math:`|\Psi\rangle` consists of.
        """
    ...
    def get_values(self):
        r"""
        Return the wave function values for each component of :math:`|\Psi\rangle`.

        :return: A list with the values of all components :math:`\psi_i` evaluated on the grid nodes :math:`\gamma`.
        """
        return self.values[:]
    ...
    def set_values(self, values, component=None):
        r"""
        Assign new function values for each component of :math:`|\Psi\rangle`.

        :param values: A list with the new values of all the :math:`\psi_i`.

        :raise ValueError: If the list ``values`` has the wrong number of entries.
        """
    ...
    def get_norm(self, values=None, summed=False, component=None):
        r"""
        Calculate the :math:`L^2` norm of the whole vector :math:`|\Psi\rangle` or some
        ...
        :return: The :math:`L^2` norm of :math:`|\Psi\rangle` or a list of the :math:`L^2` norms of
    ...
    def potential_energy(self, potential, summed=False):
        r"""
        Calculate the potential energy :math:`E_{\text{pot}} := \langle\Psi|V|\Psi\rangle` of the different components.
