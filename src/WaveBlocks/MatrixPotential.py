...
class MatrixPotential:
    """This class represents a potential :math:`V\ofs{x}`. The potential is given as an analytic
    ...
    def __init__(self):
        """Create a new I{MatrixPotential} instance for a given potential matrix :math:`V\ofs{x}`.
    ...
    def evaluate_at(self, nodes, component=None):
        ...
        :param component: The component :math:`V_{i,j}` that gets
    ...
    def evaluate_eigenvalues_at(self, nodes, diagonal_component=None):
        ...
        :param diagonal_component: The index :math:`i` of the eigenvalue :math:`\lambda_i`
    ...
    def calculate_eigenvectors(self):
        """Calculate the eigenvectors :math:`\nu_i\ofs{x}` of the potential :math:`V\ofs{x}`.
        @raise NotImplementedError: This is an abstract base class.
        """
    ...
    def evaluate_eigenvectors_at(self, nodes):
        """Evaluate the eigenvectors :math:`\nu_i\ofs{x}` at some grid nodes :math:`\gamma`.
    ...
    def calculate_exponential(self, factor=1):
        """Calculate the matrix exponential :math:`E = \exp\ofs{\alpha M}`.
