...
if __name__ == "__main__":
    ...
    for blockid in iom.get_block_ids():
        ...
        if iom.has_inhomogwavepacket(block=blockid):
            ...
            EvaluateWavepacketsInhomog.compute_evaluate_wavepackets(iom, block=blockid, basis="canonical")
        # If not, we test for a homogeneous wavepacket next
        elif iom.has_wavepacket(block=blockid):
            import EvaluateWavepackets
            EvaluateWavepackets.compute_evaluate_wavepackets(iom, block=blockid, basis="canonical")
